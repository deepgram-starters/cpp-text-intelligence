# cpp-text-intelligence

C++ (Crow) demo app for Deepgram Text Intelligence.
...
```
feat(cpp-text-intelligence): add diarization support
fix(cpp-text-intelligence): resolve WebSocket close handling
refactor(cpp-text-intelligence): simplify session endpoint
